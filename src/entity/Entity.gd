...
const suspicion_texture := preload("res://assets/images/entities/suspicion.png")
const wealth_texture := preload("res://assets/images/entities/wealth.png")
const artifact_ring_textures := [preload("res://assets/images/entities/artifacts/artifact1.png")]
const artifact_staff_textures := [preload("res://assets/images/entities/artifacts/artifact2.png")]
const artifact_blade_textures := [preload("res://assets/images/entities/artifacts/artifact3.png")]
const artifact_amulet_textures := [preload("res://assets/images/entities/artifacts/artifact4.png")]
const artifact_crown_textures := [preload("res://assets/images/entities/artifacts/artifact5.png")]
const male_textures := [preload("res://assets/images/entities/followers/male_face1.png"), preload("res://assets/images/entities/followers/male_face2.png")]
const female_textures := [preload("res://assets/images/entities/followers/female_face1.png"), preload("res://assets/images/entities/followers/female_face2.png")]
const investigator_textures := [preload("res://assets/images/entities/investigator.png")]
