...
const rumors_texture := preload("res://assets/images/assignments/rumors.png")
const investigation_texture := preload("res://assets/images/assignments/investigation.png")
const recruit_texture := preload("res://assets/images/assignments/recruit.png")
const work_texture := preload("res://assets/images/assignments/work.png")
const seek_texture := preload("res://assets/images/assignments/seek.png")
const conceal_texture := preload("res://assets/images/assignments/conceal.png")
const research_texture := preload("res://assets/images/assignments/research.png")
